...
% Timing=toc
% saveToText("Final SVM Gabor test dataset ", Timing, Accuracy, TP, FP, TN, FN, areaUnderCurve);
...
for i=1:4
    ...
    % Timing=toc;
    % saveToText("Final SVM Gabor single scale sliding " + i, Timing, Accuracy, TP, FP, TN, FN);
end
...
for i=1:4
    ...
    Accuracy = (TN+TP)/WindowIterations
    %Timing=toc;
    %saveToText("Final SVM multi scale sliding ", Timing, Accuracy, TP, FP, TN, FN);
end